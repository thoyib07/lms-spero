                    ...
                    <div class="right__content">
                      <div class="rc__top d-flex gap-3">
                        ...
                        <div class="rct__right w-100">
                          <h1 class="mb-1">Sales (Chemical)</h1>
                            ...
                            <div class="col-md-6 col-12">
                              <div class="m__left">
                                <div class="ml__content mt-1 d-flex gap-2">
                                  ...
                                  <p class="mb-1">Garuda Food</p>
                                </div>
                                <div class="ml__content mt-1 d-flex gap-2">
                                  <h2 class="fs-6">Project :</h2>
                                  <p class="mb-1">Wafer</p>
                                </div>
                                <div class="ml__content mt-1 d-flex gap-2">
                              ...
                              <div class="m__right">
                                <div class="mr__content d-flex gap-2 mb-2">
                                  ...
                                  <div class="mrc__p mt-0">
                                    <div class="skill__option d-flex gap-1 mt-0">
                                      <a class="btn btn-so" href="#" role="button">Depok</a>
                                      <a class="btn btn-so" href="#" role="button">Jakarta</a>
                                      <a class="btn btn-so" href="#" role="button">Bandung</a>
                                    </div>
                                  </div>
                                </div>
                                <div class="mr__content mt-0 d-flex gap-2">
                                  ...
                                  <div class="mrc__p">
                                    <p class="mb-2 mt-1">Perusahaan Tidak Menampilkan Gaji</p>
                                  </div>
                                </div>
                                <div class="mr__content mt-0 d-flex gap-2">
                                  <div class="mrc__img"><img src="{{asset('../img/pengalaman-icon.png')}} " alt=""></div>
                                  <div class="mrc__p">
                                    <p class="mb-n1 mt-1">1-3 Tahun Pengalaman</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="rc__middle mt-3">
                        ...
                        <div class="skill__option d-flex gap-3 mt-3">
                          <a class="btn btn-so" href="#" role="button">Penjualan</a>
                          <a class="btn btn-so" href="#" role="button">Chemical Production</a>
                          <a class="btn btn-so" href="#" role="button">Sales</a>
                          <a class="btn btn-so" href="#" role="button">Account Manager</a>
                          <a class="btn btn-so" href="#" role="button">Sales Marketing</a>
                        </div>
                      </div>
                      <hr class="bg-dark border-2 border-top border-dark m-0 mt-4">
                      <div class="rc__bottom mt-3">
                        <h1>Deskripsi Pekerjaan Sales (Chemical)</h1>
                        <div class="rcb__list">
                          <ul>
                            <li>Mampu Menjual Dan Memasarkan Sesuai Target Angka Penjualan & Angka Orang Yang Mencoba</li>
                          </ul>
                        </div>
                      </div>
                      <hr class="bg-dark border-2 border-top border-dark m-0 mt-4">
                      <div class="rc__bottom mt-3">
                        <h1>Syarat Pekerjaan Sales (Chemical)</h1>
                        <div class="rcb__list">
                          <ul>
                            <li>Minimal Pendidikan</li>
                            <li>Kejujuran</li>
                          </ul>
                        </div>
                      </div>
